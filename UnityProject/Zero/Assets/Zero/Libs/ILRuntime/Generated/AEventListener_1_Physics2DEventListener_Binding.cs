...
{
    unsafe class AEventListener_1_Physics2DEventListener_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::AEventListener<Zero.Physics2DEventListener>);
        ...
        static StackObject* Get_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = global::AEventListener<Zero.Physics2DEventListener>.Get(@gameObject);
