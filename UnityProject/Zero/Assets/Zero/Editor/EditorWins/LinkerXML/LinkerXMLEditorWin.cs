...
namespace Zero.Edit
{
    class LinkerXMLEditorWin : AEditorWin
    {
        ...
        private void OnEnable()
        {
            ...
            _latv = new LinkerAssemblyTreeView(_tvs);
        ...
        void DoSaveView()
        {
            if (GUILayout.Button("保存Linker.xml", GUILayout.Height(30)))
            {
                ...
                var savePath = FileSystem.CombinePaths(saveDir, "linker.xml");
